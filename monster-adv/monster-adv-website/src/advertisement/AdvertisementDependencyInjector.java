...
public class AdvertisementDependencyInjector {
	...
	private AdvertisementAddAction createAdvertisementAddAction() {
			AdvertisementAddAction action = new AdvertisementAddAction();
			action.setAdvertisementDAO(createAdvertisementDAO());
			return action;
